export abstract class Colorer {
    ...
    private static standardColors: string[] = [
        "red", "green", "blue", "orange", "purple", "pink", "brown", "teal", "grey", "lime",
        "red darken-2", "green darken-2", "blue darken-2", "orange darken-2", "purple darken-2", "pink darken-2", "brown darken-2", "teal darken-2", "grey darken-2", "lime darken-2"];
